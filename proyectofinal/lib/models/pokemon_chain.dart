...
//
//     final pokemonChain = pokemonChainFromJson(jsonString);

import 'dart:convert';

PokemonChain pokemonChainFromJson(String str) =>
    PokemonChain.fromJson(json.decode(str));

String pokemonChainToJson(PokemonChain data) => json.encode(data.toJson());
